...
# loop to iterate through the contents of the file that was stored in variable contents. loop then assigns show
# season to variable key and show titles to variable value IF statement is to check for multiple shows that utilize
# the same key (e.g. - ShowA and ShowB both have 20 seasons so show A and B should be concatenated and separated
# values by a semi-colon in the shared key. (e.g. - 20: ShowA ; ShowB) ElSE the single value is just set to the key.
